...
// logic — tokenizer, POSIX passes, the U9b pwsh dialect pass, and the HR1
// fail-closed backstop — lives in the descriptor-parameterized sibling
// shell-policy-core.mjs (Option-B staging; soma-notes: grok-adapter/
// 2026-06-11-001-refactor-grok-shell-policy-core-plan.md). Grok's deltas
// enter the core ONLY through the descriptor below.
