...
// helpers, the three POSIX passes, the U9b pwsh/cmd dialect pass with its
// verb tables, and the HR1 fail-closed backstop. Extracted verbatim from
// grok-policy-targets.mjs as Option-B staging for the future shared-core
// promotion (soma-notes: grok-adapter/2026-06-10-006-future-shared-shell-
// policy-extractor.md and 2026-06-11-001-refactor-grok-shell-policy-core-
// plan.md). The tool-input layer (tool-name/input-key normalization and the
...
//     deny default, the HR1 backstop, the read-only allowlist) lives here
 ...
 * (unknown-verb deny, HR1 backstop, read-only allowlist) is core behavior
