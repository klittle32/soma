// Single source of truth for the security-critical Grok hook verb (UH9,
// review #7). The PreToolUse verb is coupled across THREE call sites that
// must agree exactly, or the fail-closed gate silently disables itself on
// grok's fail-open platform (KTD-7):
